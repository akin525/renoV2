                ...
                <a href="{{route('select1')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div class="h6 m-2 text-dark">Data</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{route('airtime')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div class="h6 m-2 text-dark">Airtime</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{url('giveaway')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div class="h6 m-2 text-dark">Giveaway</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{url('waec')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div class="h6 m-2 text-dark">Waec</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="{{url('neco')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                            ...
                            <div class="h6 m-2 text-dark">Neco</div>
                        </div>
                    </div>
                </a>
            </div>
