            ...
            <div class="col-4 col-sm-3 col-lg-3">
                <a href="{{url('safelock')}}">
                    <div class="card">
                        <div class="card-body p-3 text-center">
                             <span style="font-size: 30px;">
                                 <img width="50" src="https://cdn-icons-png.flaticon.com/512/6475/6475889.png">
                             </span>
                        <small>Save Commission</small>
{{--                            <div class="h6 m-2 text-dark">Electricity</div>--}}
                        </div>
                    </div>
                </a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <center>
                        <a href="#" class="badge badge-success" onclick="openModal(this)">Withdraw profit to wallet</a>
{{--                        <a href="{{route('withdrawapi')}}" class="badge badge-danger">Withdraw profit to bank</a>--}}
