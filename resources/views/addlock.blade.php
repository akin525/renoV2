        ...
        <div class="row justify-content-lg-center">
            <div class="col-lg-10">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title text-white">Add to safe lock: {{$safe['tittle']}}</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('adlock')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="id" value="{{$safe['id']}}" required/>
                                            </div>
                                            <div class="form-group">
