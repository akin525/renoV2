                                ...
                                <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                                    ...
                                    @foreach($ads as $re)
                                        <tr>
                                            ...
                                            <td>{{$re->advert_name}}</td>
                                            <td>
                                                @if($re->status == "0")
                                                    <span class="badge badge-warning">Pending</span>
                                                    <a href="{{route('admin/approved', $re->id)}}" class="badge badge-success"><i class="fa fa-check"></i>Approve</a>
                                                    <a href="{{route('admin/disapproved', $re->id)}}" class="badge badge-danger"><i class="fa fa-close"></i>Disapprove</a>
                                                @else
